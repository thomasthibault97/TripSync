...
import { Globe, ArrowLeft, Users, Calendar, ChevronLeft, ChevronRight, Award, Check, X, Crown, Sparkles } from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-[#E5E4DE] p-5">
              <h3 className="font-['Outfit'] font-bold text-[#1C1E1D] mb-4 flex items-center gap-2 text-sm">
                <Users className="w-4 h-4 text-[#2C4234]" /> Participants
              </h3>
